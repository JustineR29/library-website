...
<head>
    ...
    <title>Bibliothèque - <?php echo($g); ?></title>
</head>
...
<body>
    ...
    <section>
        <div class="titres">
            ...
            <?php
            $sql = "SELECT * FROM library.books WHERE book_genre='$g'ORDER BY book_author"; 
            $result = $mysqli->query($sql);?>
            <h1><?php echo mb_strtoupper($g); ?></h1>
            <p><?php echo(mysqli_num_rows($result)); ?> livre(s) de ce genre</p>
        </div>
