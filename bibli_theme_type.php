...
<head>
    ...
    <title>Bibliothèque - <?php echo($t); ?></title>
</head>
...
<body>
    ...
    <section>
        <div class="titres">
            ...
            <?php
            $sql = "SELECT * FROM library.books WHERE book_tag_1='$t' OR book_tag_2='$t' OR book_tag_3='$t' ORDER BY book_author";
            $result = $mysqli->query($sql);?>
            <h1><?php echo mb_strtoupper($t); ?></h1>
            <p><?php echo(mysqli_num_rows($result)); ?> livre(s) dans ce thème</p>
        </div>
