...
<head>
    ...
    <title>Bibliothèque - <?php echo($l); ?></title>
</head>
...
<body>
    ...
    <section>
        <div class="titres">
            ...
            <?php
            $sql = "SELECT * FROM library.books WHERE book_language='$l' OR book_language_2='$l' ORDER BY book_author";
            $result = $mysqli->query($sql);?>
            <h1><?php echo mb_strtoupper($l); ?></h1>
            <p><?php echo(mysqli_num_rows($result)); ?> livre(s) dans cette langue</p>
        </div>
